...
const LinkMixBottom: Snippet = {
  ...
  source: (
    <a className='relative text-slate-50 after:absolute after:-top-[4px] after:-left-[10%] after:h-0 after:w-[120%] after:bg-slate-50 after:mix-blend-exclusion after:transition-all after:duration-300 hover:after:h-[120%]'>
      Mix bottom
    </a>
  ),
};
