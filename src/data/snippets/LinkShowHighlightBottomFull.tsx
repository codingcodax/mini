...
const LinkShowHighlightBottomFull: Snippet = {
  ...
  source: (
    <a className='relative text-slate-50 before:absolute before:bottom-0 before:left-0 before:h-full before:w-full before:origin-bottom before:scale-y-[0.35] before:bg-sky-500 before:transition-transform before:duration-300 before:ease-in-out hover:before:scale-y-100'>
