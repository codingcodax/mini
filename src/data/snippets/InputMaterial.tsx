...
const InputMaterial: Snippet = {
  ...
  playgroundLink: 'https://play.tailwindcss.com/oksHNgOycs',
  source: (
    <div className='relative bg-slate-900 text-slate-50'>
      ...
      />
      <label
        className='absolute left-0 -top-3 mx-1 cursor-text bg-inherit px-1 text-sm text-slate-500 peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-placeholder-shown:transition-all peer-focus:-top-3 peer-focus:text-sm peer-focus:text-sky-400'
        htmlFor='name'
      >
        Name
      </label>
