...
const Snippet = ({
  ...
  return (
    <li className='relative'>
      <div className='relative rounded-lg bg-slate-800 backdrop-blur dark:bg-slate-900/70 dark:ring-1 dark:ring-inset dark:ring-white/10'>
        <div className='flex h-10 items-center border-b border-slate-500/30 px-3'>
      ...
      <Menu as='div' className='absolute top-2 right-3 h-6'>
